...
export default function GoogleLoginDemo({ user }: GoogleLoginDemoProps) {
    ...
    //TODO useEffect to listen for auth state changes and update currentUser accordingly, to handle sign in from other tabs and after redirect from Google OAuth flow
    useEffect( () => {
